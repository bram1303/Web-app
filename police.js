...
`,
  ...
  await fetch(
    `https://api.airtable.com/v0/appZSaLixrkPZ7PTk/Police`,
    options
  )
...
async function getOneRecord(id) {
  ...
  await fetch(
    `https://api.airtable.com/v0/appZSaLixrkPZ7PTk/Police/${id}`,
    options
  )
    .then((response) => response.json())
    .then((data) => {
      ...
      let captain = data.fields["Captain"];
  ...
  <div class="card-body">
    ...
    <p class="card-text">Station Captain: ${captain}</p>
  </div>
